...
export function FeatureCard({
  ...
  return (
    <CardContainer className="inter-var w-full flex justify-center items-center">
      <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-[320px] md:w-[380px] h-auto rounded-xl p-6 border">
